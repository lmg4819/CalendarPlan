...
@interface BaiDuOCRViewController ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
...
- (void)viewDidLoad {
    ...
    [[AipOcrService shardService] authWithAK:@"yh2RERq9PtWYHj1BjxKEKpYk" andSK:@"iNmKU6GvAgyxcfGXR8QBAwmGY4bFHAOV"];
...
-(UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"DemoActionCell"];
    }
    return _tableView;
}
